    ...
    <style>
        * {
        ...
        :root {
            ...
            --pastel-blue: #b8d0ff;
            --pastel-green: #c9ffd0;
            --pastel-yellow: #fff9c9;
            --text-glow: 0 0 10px var(--neon-pink), 0 0 20px var(--neon-pink);
            --light-bulb-size: 120px;
        }
        
        body {
            background: linear-gradient(135deg, #ffcfe4 0%, #ff9ecb 100%);
            color: #5a2d48;
        ...
        .container {
            ...
            border-radius: 20px;
            padding: 30px;
            box-shadow: 0 0 30px rgba(255, 79, 167, 0.5);
            position: relative;
            overflow: hidden;
        ...
        @keyframes pulseBorder {
            0% { box-shadow: 0 0 20px rgba(255, 79, 167, 0.5); }
            100% { box-shadow: 0 0 40px rgba(255, 79, 167, 0.9), 0 0 60px rgba(255, 79, 167, 0.6); }
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="section" style="animation-duration: 6s;">
            ...
            <p class="blinking-text">Любимые аниме и манга:</p>
            <div class="badges">
        ...
        <div class="section" style="animation-duration: 9s;">
            ...
            <p class="blinking-text">Любимые треки:</p>
            <ul>
